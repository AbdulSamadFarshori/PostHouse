...
class ScrapingEngine:
    ...
    def __init__(
        ...
        self.chrome_bin = "/usr/bin/google-chrome"
        self.driver_bin = "/workspace/driver/chromedriver"  # this is your ./driver in the repo
        ...
        self.driver = webdriver.Chrome(service=Service(self.driver_bin), options=self.options)
